...
Begin VB.Form frm_RRR_Maintainance 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Revenue and Receipts Classification"
   ClientHeight    =   8265
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7440
   Icon            =   "frm_RRR_Maintainance.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8265
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label4 
         Caption         =   $"frm_RRR_Maintainance.frx":076A
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   12
            Charset         =   0
   ...
   Begin lvButton.lvButtons_H lvButtons_H2 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_RRR_Maintainance.frx":07FD
      ImgSize         =   24
      cBack           =   -2147483633
   End
   Begin lvButton.lvButtons_H lvButtons_H3 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_RRR_Maintainance.frx":4307
      ImgSize         =   24
      cBack           =   -2147483633
   End
   ...
   Begin lvButton.lvButtons_H cmdupdate 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_RRR_Maintainance.frx":7E11
      ImgSize         =   24
      cBack           =   -2147483633
   End
   ...
   Begin lvButton.lvButtons_H lvButtons_H4 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_RRR_Maintainance.frx":8E63
      ImgSize         =   24
      cBack           =   -2147483633
   End
   Begin lvButton.lvButtons_H lvButtons_H1 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_RRR_Maintainance.frx":C96D
      ImgSize         =   24
      cBack           =   -2147483633
   End
   Begin lvButton.lvButtons_H lvButtons_H5 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_RRR_Maintainance.frx":10477
      ImgSize         =   24
      cBack           =   -2147483633
   End
   Begin lvButton.lvButtons_H lvButtons_H6 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_RRR_Maintainance.frx":13F81
      ImgSize         =   24
      cBack           =   -2147483633
   End
   ...
   End
End
Attribute VB_Name = "frm_RRR_Maintainance"
...
End If
    ...
    opndbaseFMIS.Execute "update tblReff_RRRClassification set " & Field2 & " = '" & UCase(Trim(txtadd.Text)) & "'  where  " & Getcondition & " and " & Field1 & " = '" & Trim(txtcode.Text) & "' and actioncode = 0 "
...
Call GetAccountNames(LstAccountcode, "tblReff_RRRClassification", Field1, Field2, IIf((OptCredit.Value = True), Trim(Condition) & " and debitcredit = 0", Trim(Condition) & ""), Field1)

Else
Call GetAccountNames(LstAccountcode, "tblReff_RRRClassification", Field1, Field2, Condition, Field1)
txtadd.Enabled = True
...
Case "Accountcode"
If col = 4 Then
Call GetAccountNames(LstAccountcode, "tblReff_RRRClassification", Field1, Field2, IIf((OptCredit.Value = True), Trim(Condition) & " and debitcredit = 0", Trim(Condition) & " and debitcredit = 1"), Field1)
Else
Call GetAccountNames(LstAccountcode, "tblReff_RRRClassification", Field1, Field2, Condition, Field1)
End If
Case "Accountname"
...
Dim Newform As New frm_RRR_Maintainance
If LstAccountcode.ListItems.Count <> 0 Then
    If col + 1 > 3 Then
        ...
        For x = 1 To LstAccountcode.ListItems.Count
            If LstAccountcode.ListItems(x).Checked = True Then
                lblstat.Caption = "Deleting Account " & LstAccountcode.ListItems(x).Text
                    opndbaseFMIS.Execute "Delete from [tblReff_RRRClassification]  where " & Getcondition & " and " & Subcode & " = '" & Trim(LstAccountcode.ListItems(x).Text) & "' and actioncode = 0 "
            End If
                DoEvents
        Next x
        lblstat.Caption = ""
...
If MsgBox("Are you sure do want to save?", vbInformation + vbYesNo, "System Message") = vbYes Then
    ...
    If col = 0 Or col = 1 Then
        opndbaseFMIS.Execute "Insert into tblReff_RRRClassification (Subcode1, Subdesc1,lvl,ACTIONCODE) values ('" & txtcode & "','" & UCase(Replace(txtadd.Text, "'", "''")) & "'," & col & ",0)"
        Call GetAccountNames(LstAccountcode, "tblReff_RRRClassification", Field1, Field2, Condition, Field1)
    ElseIf col = 2 Then
        opndbaseFMIS.Execute "Insert into tblReff_RRRClassification (Subcode1, Subdesc1, Subcode2, Subdesc2,lvl,actioncode) values ('" & Subcode1 & "','" & Replace(Subdesc1, "'", "''") & "','" & txtcode & "','" & UCase(Replace(txtadd.Text, "'", "''")) & "'," & col & ",0)"
        Call GetAccountNames(LstAccountcode, "tblReff_RRRClassification", Field1, Field2, Condition, Field1)
    ElseIf col = 3 Then
        opndbaseFMIS.Execute "Insert into tblReff_RRRClassification (Subcode1, Subdesc1, Subcode2, Subdesc2,Subcode3, Subdesc3,lvl,actioncode) values ('" & Subcode1 & "','" & Replace(Subdesc1, "'", "''") & "','" & Subcode2 & "','" & Replace(Subdesc2, "'", "''") & "','" & txtcode & "','" & UCase(Replace(txtadd.Text, "'", "''")) & "'," & col & ",0)"
        Call GetAccountNames(LstAccountcode, "tblReff_RRRClassification", Field1, Field2, Condition, Field1)
    ElseIf col = 4 Then
        opndbaseFMIS.Execute "Insert into tblReff_RRRClassification (Subcode1, Subdesc1, Subcode2, Subdesc2,Subcode3, Subdesc3,Subcode4, Subdesc4,lvl,actioncode) values ('" & Subcode1 & "','" & Replace(Subdesc1, "'", "''") & "','" & Subcode2 & "','" & Replace(Subdesc2, "'", "''") & "','" & Subcode3 & "','" & Replace(Subdesc3, "'", "''") & "','" & txtcode & "','" & UCase(Replace(txtadd.Text, "'", "''")) & "'," & col & ",0)"
        Call GetAccountNames(LstAccountcode, "tblReff_RRRClassification", Field1, Field2, IIf((OptCredit.Value = True), Trim(Condition) & " and debitcredit = 0", Trim(Condition) & " and debitcredit = 1"), Field1)
    Else
...
Select Case col:
Case 1, 0
sql = "Select   max(subcode1) as maxid from tblReff_RRRClassification where " & Getcondition & ""
Case 2
    sql = "Select   max(subcode2) as maxid from tblReff_RRRClassification where " & Getcondition & ""
Case 3
    sql = "Select max(subcode3) as maxid from tblReff_RRRClassification where " & Getcondition & ""
Case 4
sql = "Select max(subcode4) as maxid from tblReff_RRRClassification where " & Getcondition & ""
Case 5
    sql = "Select max(subcode5) as maxid from tblReff_RRRClassification where " & Getcondition & ""
Case 6
    sql = "Select max(subcode6) as maxid from tblReff_RRRClassification where " & Getcondition & ""
Case 7
    sql = "Select max(subcode7) as maxid from tblReff_RRRClassification where " & Getcondition & ""
End Select
