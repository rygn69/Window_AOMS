...
Begin VB.Form frmJEVNumberingForCashReceipts 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "JEV Numbering for Cash Receipts Report"
   ClientHeight    =   10080
   ClientLeft      =   150
   ClientTop       =   1380
   ClientWidth     =   14370
   Icon            =   "frmJEVNumberingForCashReceipts.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox Combo1 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmJEVNumberingForCashReceipts.frx":0E42
         Left            =   75
         List            =   "frmJEVNumberingForCashReceipts.frx":0E4F
         TabIndex        =   26
         Top             =   360
         Width           =   2910
      End
   ...
   Begin VB.ListBox List1 
      ...
      EndProperty
      Height          =   3900
      ItemData        =   "frmJEVNumberingForCashReceipts.frx":0E85
      Left            =   3600
      List            =   "frmJEVNumberingForCashReceipts.frx":0E87
      TabIndex        =   4
      Top             =   840
      Width           =   3300
   End
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmJEVNumberingForCashReceipts.frx":0E89
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmJEVNumberingForCashReceipts.frx":1F0B
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmJEVNumberingForCashReceipts.frx":4045
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmJEVNumberingForCashReceipts.frx":40A3
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmJEVNumberingForCashReceipts.frx":43BD
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmJEVNumberingForCashReceipts"
...
For cc = 1 To grd_details.Rows - 2
    ...
    If grd_details.TextMatrix(cc, 4) = 2 Then
        ...
        If opnJEV.RecordCount <> 0 Then
            ...
            grd_details.TextMatrix(cc, 14) = opnJEV!FundCode & "-" & Right(DTPicker1.Year, 2) & "-" & Format((DTPicker1.Month), "00") & "-" & Format(opnJEV!TransType, "00") & "-" & Format(LastJEVSNno, "00000")
...
For cc = 1 To grd_details.Rows - 2
        ...
        If Len(Trim(grd_details.TextMatrix(cc, 14))) > 0 Then
            If grd_details.TextMatrix(cc, 14) = "000-00-00-00-xxxxx" Then
            Else
