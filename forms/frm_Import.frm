...
Dim x As Integer
List1.Clear
rec.Open "Select trnno,sqldesc from tblAMIS_SqlQuery", opndbaseFMIS, adOpenStatic, adLockBatchOptimistic
List1.AddItem ""
List1.Clear
    If rec.RecordCount > 0 Then
...
Resumes:
        If Trim(MSHFlexGrid1.TextMatrix(x, 1)) <> "" Or Trim(MSHFlexGrid1.TextMatrix(x, 2)) <> "" Then
            If Optin.Value = True Then
                Code = Trim(MSHFlexGrid1.TextMatrix(x, 1))
            ...
            If ExecFunction("Select [fmis].[dbo].[MPfunc_ChkIfAlreadyInCOAbyCODE] (" & val(col) & ",'" & Trim(accntcode) & "-" & Code & "')") = 1 Then
                ...
                'End If
            Else
                If ExecFunction("Select [fmis].[dbo].[MPfunc_ChkIfAlreadyInCOAbydesc] ( " & val(col) & ",'" & Trim(accntcode) & "', '" & Replace(Trim(MSHFlexGrid1.TextMatrix(x, 2)), "'", "''") & "')") = 1 Then
                ...
                Else
                    ...
                    If Trim(MSHFlexGrid1.TextMatrix(x, 2)) <> "" And Code <> "" Then
                    
                        If col = 2 Then
                            opndbaseFMIS.Execute "Insert into tblReff_CodeClassification (Subcode1, Subdesc1, Subcode2, Subdesc2,lvl) values ('" & Subcode1 & "','" & Replace(Subdesc1, "'", "''") & "','" & Code & "','" & Replace(UCase(Trim(MSHFlexGrid1.TextMatrix(x, 2))), "'", "''") & "'," & col & ")"
                        ElseIf col = 3 Then
                            opndbaseFMIS.Execute "Insert into tblReff_CodeClassification (Subcode1, Subdesc1, Subcode2, Subdesc2,Subcode3, Subdesc3,lvl) values ('" & Subcode1 & "','" & Replace(Subdesc1, "'", "''") & "','" & Subcode2 & "','" & Replace(Subdesc2, "'", "''") & "','" & Code & "','" & Replace(UCase(Trim(MSHFlexGrid1.TextMatrix(x, 2))), "'", "''") & "'," & col & ")"
                        ElseIf col = 4 Then
                            opndbaseFMIS.Execute "Insert into tblReff_CodeClassification (Subcode1, Subdesc1, Subcode2, Subdesc2,Subcode3, Subdesc3,Subcode4, Subdesc4,lvl) values ('" & Subcode1 & "','" & Replace(Subdesc1, "'", "''") & "','" & Subcode2 & "','" & Replace(Subdesc2, "'", "''") & "','" & Subcode3 & "','" & Replace(Subdesc3, "'", "''") & "','" & Code & "','" & Replace(UCase(Trim(MSHFlexGrid1.TextMatrix(x, 2))), "'", "''") & "'," & col & ")"
                        ElseIf col = 5 Then
                            opndbaseFMIS.Execute "Insert into tblReff_CodeClassification (Subcode1, Subdesc1, Subcode2, Subdesc2,Subcode3, Subdesc3,Subcode4, Subdesc4,Subcode5, Subdesc5,lvl) values ('" & Subcode1 & "','" & Replace(Subdesc1, "'", "''") & "','" & Subcode2 & "','" & Replace(Subdesc2, "'", "''") & "','" & Subcode3 & "','" & Replace(Subdesc3, "'", "''") & "','" & Subcode4 & "','" & Replace(Subdesc4, "'", "''") & "','" & Code & "','" & Replace(UCase(Trim(MSHFlexGrid1.TextMatrix(x, 2))), "'", "''") & "'," & col & ")"
                        ElseIf col = 6 Then
                            opndbaseFMIS.Execute "Insert into tblReff_CodeClassification (Subcode1, Subdesc1, Subcode2, Subdesc2,Subcode3, Subdesc3,Subcode4, Subdesc4,Subcode5, Subdesc5,Subcode6, Subdesc6,lvl) values ('" & Subcode1 & "','" & Replace(Subdesc1, "'", "''") & "','" & Subcode2 & "','" & Replace(Subdesc2, "'", "''") & "','" & Subcode3 & "','" & Replace(Subdesc3, "'", "''") & "','" & Subcode4 & "','" & Replace(Subdesc4, "'", "''") & "','" & Subcode5 & "','" & Replace(Subdesc5, "'", "''") & "','" & Code & "','" & Replace(UCase(Trim(MSHFlexGrid1.TextMatrix(x, 2))), "'", "''") & "'," & col & ")"
                        ElseIf col = 7 Then
                            opndbaseFMIS.Execute "Insert into tblReff_CodeClassification (Subcode1, Subdesc1, Subcode2, Subdesc2,Subcode3, Subdesc3,Subcode4, Subdesc4,Subcode5, Subdesc5,Subcode6, Subdesc6,Subcode7, Subdesc7,lvl) values ('" & Subcode1 & "','" & Replace(Subdesc1, "'", "''") & "','" & Subcode2 & "','" & Replace(Subdesc2, "'", "''") & "','" & Subcode3 & "','" & Replace(Subdesc3, "'", "''") & "','" & Subcode4 & "','" & Replace(Subdesc4, "'", "''") & "','" & Subcode5 & "','" & Replace(Subdesc5, "'", "''") & "','" & Subcode6 & "','" & Replace(Subdesc6, "'", "''") & "','" & Code & "','" & Replace(UCase(Trim(MSHFlexGrid1.TextMatrix(x, 2))), "'", "''") & "'," & col & ")"
                        Else
