...
Begin VB.Form frmcheckdisbursement 
   ...
   End
End
Attribute VB_Name = "frmcheckdisbursement"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New Rpt_checkConsolidated
...
If Not rs6.EOF Then
    ...
    CRViewer91.ReportSource = Report
        With Report
         ...
         '  .Subreport1_Text3.SetText Trim(fund) & "-" & Trim(mnth)
