...
Begin VB.Form frm_Inventory 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Import from Inventory"
   ClientHeight    =   8910
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10725
   Icon            =   "frm_Inventory.frx":0000
   LinkTopic       =   "Form4"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8910
   ...
   End
End
Attribute VB_Name = "frm_Inventory"
