...
Begin VB.Form frmJEVPreparationforAjustment 
   ...
   EndProperty
   Icon            =   "frmJEVPreparationforAjustment.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9795
      ...
      Begin MSComctlLib.ImageList itb32x32 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":076A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":20FC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":3A8E
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":5420
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":6DB2
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":8744
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":A0D6
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":BA68
               Key             =   ""
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":D3FA
               Key             =   ""
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":ED8E
               Key             =   ""
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":FA6A
               Key             =   ""
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":1034A
               Key             =   ""
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":11026
               Key             =   ""
            EndProperty
            BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":11D02
               Key             =   ""
            EndProperty
            BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":129DE
               Key             =   ""
            EndProperty
            BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":136BA
               Key             =   ""
            EndProperty
            BeginProperty ListImage17 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmJEVPreparationforAjustment.frx":14396
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmJEVPreparationforAjustment"
...
frmPOstdate.Show 1
If JevOk = True Then
    rec.Open ("EXEC [dbo].[Proc_GetMaxJevSeries] @transtype = 4,@jevyeardate = '" & Year(DatePost) & "' ,@fundtype = '" & txtFund.Text & "'"), opndbaseFMIS, adOpenStatic, adLockOptimistic
        Lastno = rec.Fields!MAXJEVSERIES
    rec.Close
    
    txtJEVNo.Text = txtFund.ItemData(txtFund.ListIndex) & "-" & Right(Year(DatePost), 2) & "-" & Format(Month(DatePost), "00") & "-" & "04" & "-" & Format(Lastno, "00000")
End If
End Sub
...
'                                        opndbaseFMIS.Execute "Insert Into tblAMIS_FinalJEV " & _
'                                        " (refno,Date_,Particular,Gamount,FmisAccountcode,Debit,Credit,Fundtype,JevSeriesNo,DateTimeEntered,Jevdate,actioncode,IsAdjustment,transtype,jevno) " & _
'                                        " values ('" & txtDVNo.Text & "','" & txtDate.Text & "','" & Replace(txtParticular.Text, "'", "''") & "'," & CLng(txtAmount.Text) & "," & CLng(MSFlexGrid1.TextMatrix(x, 0)) & "," & CCur(IIf(IsNumeric(MSFlexGrid1.TextMatrix(x, 3)), MSFlexGrid1.TextMatrix(x, 3), 0)) & "," & CCur(IIf(IsNumeric(MSFlexGrid1.TextMatrix(x, 4)), MSFlexGrid1.TextMatrix(x, 4), 0)) & ",'" & txtFund.Text & "','" & Mid(txtJEVNo.Text, 14, 7) & "','" & Format(Now, "yyyy/mm/dd hh:mm:ss AMPM") & "','" & DatePost & "',1,1,4,'" & txtJEVNo.Text & "')"
'
                                        Call Saved2FinalJEV(txtDate.Text, "", "", txtParticular.Text, txtJEVNo.Text, "", CLng(MSFlexGrid1.TextMatrix(x, 0)), txtAmount.Text, CCur(IIf(IsNumeric(MSFlexGrid1.TextMatrix(x, 3)), MSFlexGrid1.TextMatrix(x, 3), 0)), CCur(IIf(IsNumeric(MSFlexGrid1.TextMatrix(x, 4)), MSFlexGrid1.TextMatrix(x, 4), 0)), "4", "", "", "", txtFund.Text, "", "", "", txtDVNo.Text, Mid(txtJEVNo.Text, 14, 20), DatePost, "")
