...
Begin VB.Form frm_Schedule 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox cmb_Accountcode 
         ...
         EndProperty
         Height          =   420
         ItemData        =   "frm_Schedule.frx":E923
         Left            =   0
         List            =   "frm_Schedule.frx":E925
         TabIndex        =   5
         Top             =   3480
         Width           =   3465
      End
      Begin VB.ComboBox cmb_FundType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frm_Schedule.frx":E927
         Left            =   120
         List            =   "frm_Schedule.frx":E934
...
Report9 = "Schedules"
With frm
.query = "EXEC [fmis].[dbo].[MPproc_RPT_Financials] @from ='" & DTPicker2.Value & "',@to='" & DTPicker1.Value & "',@Accountcode ='',@Fundtype ='" & cmb_FundType.Text & "',@reports = 'Schedules'"
