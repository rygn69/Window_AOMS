...
Dim IfConSo As Integer
    ...
    CrystalReportBS.Database.SetDataSource opndbaseFMIS.Execute("Exec Pro_RPTBalanceSheet @isconsolidated = " & IfConSo & ",@year = " & DTPicker2.Year & ", @month=" & DTPicker1.Month & " ,@fundtype = '" & cboFundType.Text & "'")
    CrystalReportBS.txtdate.SetText "As of " & Format(DTPicker1.Value, "MMMM") & " " & DTPicker2.Year
    'CrystalReportBS.txtClerk.SetText getUserName(ActiveUserID, "FullName")
