...
Begin VB.Form frmConnCheck 
   ...
   ControlBox      =   0   'False
   Enabled         =   0   'False
   Icon            =   "frmConnCheck.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmConnCheck.frx":000C
   ScaleHeight     =   2370
   ScaleWidth      =   9480
   ...
   End
End
Attribute VB_Name = "frmConnCheck"
...
handler:
If err.Number <> 0 Then
    If MsgBox("Unable to Connect to Database" & vbNewLine & "Retry?", vbInformation + vbYesNo, "System Message") = vbYes Then
        GoTo returned
    Else
    End
    End If
