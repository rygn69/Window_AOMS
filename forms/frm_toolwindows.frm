...
Begin VB.Form frm_toolwindows 
   ...
   Begin lvButton.lvButtons_H lvButtons_H2 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_toolwindows.frx":1272
      cBack           =   -2147483633
   End
   ...
   Begin VB.Timer tmrTv 
      ...
      Top             =   360
   End
   Begin MSComctlLib.TreeView TrvObject 
      Height          =   7095
      Left            =   120
      TabIndex        =   0
      Top             =   600
   ...
   Begin MSComctlLib.ImageList imgNode 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_toolwindows.frx":4D7C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_toolwindows.frx":59CE
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_toolwindows.frx":6620
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_toolwindows.frx":7272
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_toolwindows.frx":7EC4
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_toolwindows.frx":8B16
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_toolwindows.frx":9768
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_toolwindows.frx":D272
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_toolwindows.frx":D9EC
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin lvButton.lvButtons_H lvButtons_H1 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_toolwindows.frx":E3E6
      cBack           =   -2147483633
   End
   Begin lvButton.lvButtons_H lvButtons_H3 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_toolwindows.frx":11EF0
      cBack           =   -2147483633
   End
   Begin VB.Line Line2 
      X1              =   4800
   ...
   End
End
Attribute VB_Name = "frm_toolwindows"
...
'xNode.Expanded = True
sqlQry = "select * from tblAMIS_FinaluserNodes where userid = '" & Trim(ActiveUserID) & "' order by id" ' where nodeLevel=1"
xRsTemp1.Open sqlQry, opndbaseFMIS, adOpenDynamic, adLockOptimistic
With xRsTemp1
    If Not .BOF Or Not .EOF Then
        Do While Not .EOF
                xParent = Trim(.Fields("childOf"))
                If xParent = "a" Then
                Set xNode = TrvObject.Nodes.Add(, , Trim(.Fields("nodekey")), Trim(.Fields("nodeText")), 3)
                Else
                    Set xNode = TrvObject.Nodes.Add(xParent, tvwChild, Trim(.Fields("nodekey")), Trim(.Fields("nodeText")), CInt(xRsTemp1!Icon))
                End If
        .MoveNext
        Loop
    End If
...
'    centerme frm_JEVPreparationChkD
'    frm_JEVPreparationChkD.Ttype = 2
'    frm_JEVPreparationChkD.ZOrder (0)
'    frm_JEVPreparationChkD.Frame1.Enabled = False
'     frm_JEVPreparationChkD.cmd_post.Visible = False
'     frm_JEVPreparationChkD.Command1.Visible = False
'     frm_JEVPreparationChkD.txt_Jevno.Visible = False
'    frm_JEVPreparationChkD.Show
...
ElseIf xSelNodeId = "a47" Then
    centerme frm_SIE_byRcenter
    frm_SIE_byRcenter.ZOrder (0)
    frm_SIE_byRcenter.Show
...
ElseIf xSelNodeId = "a53" Then
    centerme frm_AccountsPayable
    frm_AccountsPayable.ZOrder (0)
    frm_AccountsPayable.Show
...
ElseIf xSelNodeId = "a66" Then
    centerme frm_forCashAdvanceMgmnt
    frm_forCashAdvanceMgmnt.ZOrder (0)
    frm_forCashAdvanceMgmnt.Show
ElseIf xSelNodeId = "a67" Then
    centerme frm_UploadIS
    frm_UploadIS.ZOrder (0)
    frm_UploadIS.Show
ElseIf xSelNodeId = "a68" Then
    centerme frm_UserDetails
    frm_UserDetails.ZOrder (0)
    frm_UserDetails.Show
ElseIf xSelNodeId = "a69" Then
    centerme frm_Monitoring
    frm_Monitoring.ZOrder (0)
    frm_Monitoring.Show
ElseIf xSelNodeId = "a70" Then
    centerme frm_Audited
    frm_Audited.ZOrder (0)
    frm_Audited.Show
ElseIf xSelNodeId = "a71" Then
    centerme frm_transactionViewer
    frm_transactionViewer.ZOrder (0)
    frm_transactionViewer.Show
ElseIf xSelNodeId = "a72" Then
    centerme frm_POReg
    frm_POReg.ZOrder (0)
    frm_POReg.Show
ElseIf xSelNodeId = "a73" Then
    centerme frm_RRR
    frm_RRR.ZOrder (0)
    frm_RRR.Show
ElseIf xSelNodeId = "a74" Then
    centerme frm_Updateposition
    frm_Updateposition.ZOrder (0)
    frm_Updateposition.Show
ElseIf xSelNodeId = "a75" Then
    centerme frmOfficeSelectSAAO
    frmOfficeSelectSAAO.ZOrder (0)
    frmOfficeSelectSAAO.Show
ElseIf xSelNodeId = "a76" Then
    centerme frm_SE_Option
    frm_SE_Option.ZOrder (0)
    frm_SE_Option.Show
ElseIf xSelNodeId = "a77" Then
    centerme frm_CAnotify
    frm_CAnotify.ZOrder (0)
    frm_CAnotify.Show
ElseIf xSelNodeId = "a79" Then
    centerme f_COA_GL
    f_COA_GL.ZOrder (0)
    f_COA_GL.Show
ElseIf xSelNodeId = "a80" Then
    centerme f_COA_SL
    f_COA_SL.ZOrder (0)
    f_COA_SL.Show
ElseIf xSelNodeId = "a81" Then
    centerme frm_jev_prepare
    frm_jev_prepare.ZOrder (0)
    frm_jev_prepare.Show
End If
End Sub
