...
Begin VB.Form frm_SGE 
   ...
   ClientTop       =   4380
   ClientWidth     =   3900
   Icon            =   "frm_SGE.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frm_SGE.frx":076A
   ScaleHeight     =   4965
   ScaleWidth      =   3900
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox cmb_Accountcode 
         ...
         EndProperty
         Height          =   420
         ItemData        =   "frm_SGE.frx":E923
         Left            =   0
         List            =   "frm_SGE.frx":E925
         TabIndex        =   5
         Top             =   3480
         Width           =   3465
      End
      Begin VB.ComboBox cmb_FundType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frm_SGE.frx":E927
         Left            =   120
         List            =   "frm_SGE.frx":E934
...
Report9 = "SGE"
With frm
.query = "EXEC [fmis].[dbo].[MPproc_New_RPT_Financials] @from ='" & DTPicker2.Value & "',@to='" & DTPicker1.Value & "',@Accountcode ='',@fundcode = '" & cmb_FundType.ItemData(cmb_FundType.ListIndex) & "',@reports = 'SGE'"
.dated = "As of " & Format(DTPicker1.Value, "MMMM, yyyy")
