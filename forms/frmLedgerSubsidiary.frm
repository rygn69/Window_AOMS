...
Begin VB.Form frmLedgerSubsidiary 
   ...
   ClientTop       =   3840
   ClientWidth     =   3945
   Icon            =   "frmLedgerSubsidiary.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frmLedgerSubsidiary.frx":076A
   ScaleHeight     =   4950
   ScaleWidth      =   3945
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin lvButton.lvButtons_H lvButtons_H3 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmLedgerSubsidiary.frx":AE19
         cBack           =   16777215
      End
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox cmb_Accountcode 
         ...
         EndProperty
         Height          =   420
         ItemData        =   "frmLedgerSubsidiary.frx":E923
         Left            =   120
         List            =   "frmLedgerSubsidiary.frx":E925
         TabIndex        =   5
         Top             =   1560
         Width           =   2985
      End
      Begin VB.ComboBox cmb_FundType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmLedgerSubsidiary.frx":E927
         Left            =   120
         List            =   "frmLedgerSubsidiary.frx":E934
      ...
      Begin lvButton.lvButtons_H lvButtons_H1 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmLedgerSubsidiary.frx":E96A
         cBack           =   16777215
      End
   ...
   Begin VB.CommandButton dsf 
      ...
      Height          =   735
      Left            =   1320
      Picture         =   "frmLedgerSubsidiary.frx":F5BC
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   5520
      Width           =   2175
   ...
   Begin lvButton.lvButtons_H Command1 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmLedgerSubsidiary.frx":FD26
      cBack           =   16777215
   End
   ...
   Begin lvButton.lvButtons_H lvButtons_H2 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmLedgerSubsidiary.frx":10720
      cBack           =   16777215
   End
   ...
   End
End
Attribute VB_Name = "frmLedgerSubsidiary"
...
Report9 = "Subsidiary"
With frm
Set .Rsource = Rpt_Ledger_Subsidiary
.query = "EXECUTE [fmis].[dbo].[MPproc_New_RPT_Financials] '" & DTPicker2.Value & "','" & DTPicker1.Value & "','" & cmb_Accountcode.Text & "'," & cmb_FundType.ItemData(cmb_FundType.ListIndex) & ",'Subsidiary'"
.dated = "From " & Format(DTPicker2.Value, "MMMM dd, yyyy") & " To " & Format(DTPicker1.Value, "MMMM dd, yyyy")
.accountcode = Left(cmb_Accountcode, 3)
.childaccountcode = cmb_Accountcode.Text
.FundType = Trim(cmb_FundType.Text)
.Accountname = LoadAccountsByNames(cmb_Accountcode.Text, "Accountname")
.person = LoadAccountsByNames(cmb_Accountcode.Text, "Name")
.Show
End With
Exit Sub
bad:
