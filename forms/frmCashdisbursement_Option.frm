...
Begin VB.Form frmcashdisbursement_Option 
   ...
   ClientTop       =   4380
   ClientWidth     =   4050
   Icon            =   "frmCashdisbursement_Option.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frmCashdisbursement_Option.frx":09EA
   ScaleHeight     =   5430
   ScaleWidth      =   4050
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmb_FundType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmCashdisbursement_Option.frx":B099
         Left            =   240
         List            =   "frmCashdisbursement_Option.frx":B0A6
         TabIndex        =   4
         Text            =   "cmb"
         Top             =   600
         Width           =   3420
   ...
   Begin lvButton.lvButtons_H Command1 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmCashdisbursement_Option.frx":B0DC
      cBack           =   16777215
   End
   Begin lvButton.lvButtons_H lvButtons_H1 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmCashdisbursement_Option.frx":BAD6
      cBack           =   16777215
   End
   ...
   End
End
Attribute VB_Name = "frmcashdisbursement_Option"
...
End If
 ...
 .Jquery = "Exec MPproc_RPTJournals @month = " & trnMonth & ",@year = " & TrnYear & ",@fundtype = '" & FTYPE & "',@Transtype = 3"

If chkRecap.Value = 1 Then
.WRecap = True
    If OptConso.Value = True Then
    .Rquery = "Exec MPproc_RPTRecap_Journals_Conso @month = " & trnMonth & ",@year = " & TrnYear & ",@fundtype = '" & FTYPE & "',@Transtype = 3"
    Else
    .Rquery = "Exec MPproc_RPTRecap_Journals @month = " & trnMonth & ",@year = " & TrnYear & ",@fundtype = '" & FTYPE & "',@Transtype = 3"
    End If
Else
.WRecap = False
End If
