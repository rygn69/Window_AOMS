...
Begin VB.Form frm_SubAccountcode 
   ...
   ClientTop       =   435
   ClientWidth     =   9600
   Icon            =   "frm_SubAccountcode.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8565
   ...
   Begin lvButton.lvButtons_H lvButtons_H4 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_SubAccountcode.frx":076A
      cBack           =   -2147483633
   End
   ...
   Begin lvButton.lvButtons_H lvButtons_H1 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_SubAccountcode.frx":4274
      cBack           =   16777215
   End
   Begin lvButton.lvButtons_H lvButtons_H2 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_SubAccountcode.frx":45C6
      cBack           =   16777215
   End
   Begin lvButton.lvButtons_H lvButtons_H3 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frm_SubAccountcode.frx":4918
      cBack           =   16777215
   End
   ...
   End
End
Attribute VB_Name = "frm_SubAccountcode"
