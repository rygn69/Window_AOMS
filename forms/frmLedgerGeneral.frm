...
Begin VB.Form frmLedgerGeneral 
   ...
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frmLedgerGeneral.frx":076A
   ScaleHeight     =   5055
   ScaleWidth      =   3960
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin lvButton.lvButtons_H lvButtons_H3 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmLedgerGeneral.frx":AE19
         cBack           =   16777215
      End
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox cmb_Accountcode 
         ...
         EndProperty
         Height          =   420
         ItemData        =   "frmLedgerGeneral.frx":E923
         Left            =   120
         List            =   "frmLedgerGeneral.frx":E925
         TabIndex        =   5
         Top             =   1560
         Width           =   3465
      End
      Begin VB.ComboBox cmb_FundType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmLedgerGeneral.frx":E927
         Left            =   120
         List            =   "frmLedgerGeneral.frx":E934
   ...
   Begin VB.CommandButton dsf 
      ...
      Height          =   735
      Left            =   1320
      Picture         =   "frmLedgerGeneral.frx":E96A
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   5520
      Width           =   2175
   ...
   Begin lvButton.lvButtons_H Command1 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmLedgerGeneral.frx":F0D4
      cBack           =   16777215
   End
   ...
   Begin lvButton.lvButtons_H lvButtons_H2 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "frmLedgerGeneral.frx":FACE
      cBack           =   16777215
   End
   ...
   End
End
Attribute VB_Name = "frmLedgerGeneral"
...
'Dim cc As Integer
'Dim Report As New Rpt_SubsidiaryLedger
''With Rpt_SubsidiaryLedger

Report9 = "General"
With frm
.query = "EXECUTE [fmis].[dbo].[MPproc_New_RPT_Financials] @from ='" & DTPicker1.Value & "',@to='" & DTPicker2.Value & "',@Accountcode ='" & cmb_Accountcode.Text & "',@Fundcode =" & cmb_FundType.ItemData(cmb_FundType.ListIndex) & ",@reports = 'General Ledger'"
.dated = "As of " & Format(DTPicker2.Value, "MMMM yyyy")
.accountcode = Left(cmb_Accountcode, 3)
.FundType = Trim(cmb_FundType.Text)
.Accountname = LoadAccountsByNames(cmb_Accountcode.Text, "Accountname")
.Show
End With
Exit Sub
bad:
...
If cmb_Accountcode.Text <> "" Or cmb_FundType.Text <> "" Then
...
Call LoadFundType(cmb_FundType)
Call loadAccountcodefromCOAM(cmb_Accountcode)
DTPicker1.Value = Now
End Sub
