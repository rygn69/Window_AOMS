...
Begin VB.Form frm_JEVPreparationChkD 
   ...
   EndProperty
   Icon            =   "frm_PreparationChckD.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   480
      Left            =   11880
      Picture         =   "frm_PreparationChckD.frx":076A
      Style           =   1  'Graphical
      TabIndex        =   66
      Top             =   5040
      Visible         =   0   'False
   ...
   Begin VB.CommandButton cmd_post 
      ...
      Height          =   1125
      Left            =   12480
      Picture         =   "frm_PreparationChckD.frx":08B4
      Style           =   1  'Graphical
      TabIndex        =   64
      Top             =   4800
      Visible         =   0   'False
   ...
   Begin VB.CommandButton cmdsave 
      ...
      Height          =   615
      Left            =   4800
      Picture         =   "frm_PreparationChckD.frx":43AE
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_PreparationChckD.frx":46F0
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm_PreparationChckD.frx":4B42
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Frame fmeCA 
         ...
         Begin VB.CommandButton Command7 
            ...
            Height          =   735
            Left            =   9600
            Picture         =   "frm_PreparationChckD.frx":4E5C
            Style           =   1  'Graphical
            TabIndex        =   56
            Top             =   240
            Visible         =   0   'False
         ...
         Begin VB.CommandButton Command5 
            ...
            Height          =   735
            Left            =   10440
            Picture         =   "frm_PreparationChckD.frx":529E
            Style           =   1  'Graphical
            TabIndex        =   55
            Top             =   240
            Visible         =   0   'False
         ...
         Begin VB.CommandButton Command4 
            ...
            Height          =   735
            Left            =   11280
            Picture         =   "frm_PreparationChckD.frx":56E0
            Style           =   1  'Graphical
            TabIndex        =   54
            Top             =   240
            Width           =   735
         ...
         Begin VB.CommandButton Command6 
            ...
            Height          =   495
            Left            =   12960
            Picture         =   "frm_PreparationChckD.frx":5C6A
            TabIndex        =   43
            Top             =   240
            Width           =   975
         End
   ...
   End
End
Attribute VB_Name = "frm_JEVPreparationChkD"
...
, Credit As Currency, Transtype As Integer, FmisVoucherno As String, dvno As String, obrno As String, FTYPE As String, _
 RCenter As String, OOE As String, RDOno As String, RefNo As String, Jevseries As Long, jevdate As Date, ptvNo As String, Uno As Long
...
If opnDV.RecordCount <> 0 Then
    LoadTrans
    obrno = opnDV!obrno
    If GetFundName(opnDV!FundType) = "" Then
    
    End If
    txt_FundType.Text = GetFundName(opnDV!FundType)
...
txt_FundType.Text = cmb_fundtype.Text
    ...
    If optObR.Value = True Or optNonObR.Value = True Then
          If ChkEntry = True Then
            If MsgBox("Are you sure you want to save this transaction?", vbQuestion + vbYesNo) = vbYes Then
                ...
                Drec.Close
'
                Call GEtCompleteJEVDetails(Trim(txt_DVNo.Text), "TempPost", txtcheckdate.Text, txtrcino.Text, txtCheckno.Text _
                                , txt_particular.Text, "", ClaimantCode, FmisAccountcode, Gamount, Debit, Credit, 2, FmisVoucherno, txt_DVNo.Text, obrno, txt_FundType.Text, RCenter _
                                , OOE, RDOno, RefNo, 0, Now, txtptvno.Text)
...
End Sub
Private Sub txt_DVNo_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    Call LoadBackDVDetails(txt_DVNo.Text)
    Call LoadCheckDateRCIPTVNO
End If
End Sub
Private Sub LoadCheckDateRCIPTVNO()
Dim Srec As New ADODB.Recordset
Set Srec = opndbaseFMIS.Execute("execute MPproc_GetRCIChecknoCheckDate '" & txt_DVNo.Text & "'")
If Srec.RecordCount > 0 Then
    txtCheckno.Text = Srec!checkno
    txtptvno.Text = Srec!ptvNo
    txtrcino.Text = Srec!RCINo
    txtcheckdate.Text = Srec!checkdate
Else
    txtCheckno.Text = ""
    txtptvno.Text = ""
    txtrcino.Text = ""
