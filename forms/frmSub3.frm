...
Begin VB.Form frmSub3 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmSub3.frx":4274
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Picture1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Cash Flow Entry"
      TabPicture(1)   =   "frmSub3.frx":4290
...
End If
    ...
    Case 3 To 5 'Debit/Credit
        cmbEntry.Visible = False
        Picture2.Visible = False
        If ExecFunction("SELECT [fmis].[dbo].[Mpfunc_ChckIfHaveSub] ('" & Trim(MSFlexGrid1.TextMatrix(MSFlexGrid1.Row, 1)) & "',0)") > 1 Then 'go to the subsidiary if have sub account
        txt_entry.Visible = False
