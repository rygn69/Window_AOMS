...
Begin VB.Form frm_SIE 
   ...
   ClientTop       =   4380
   ClientWidth     =   3900
   Icon            =   "frm_SIE.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frm_SIE.frx":076A
   ScaleHeight     =   4965
   ScaleWidth      =   3900
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox cmbRC 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frm_SIE.frx":E923
         Left            =   120
         List            =   "frm_SIE.frx":E930
      ...
      Begin VB.ComboBox cmb_Accountcode 
         ...
         EndProperty
         Height          =   420
         ItemData        =   "frm_SIE.frx":E966
         Left            =   0
         List            =   "frm_SIE.frx":E968
         TabIndex        =   5
         Top             =   3480
         Width           =   3465
      End
      Begin VB.ComboBox cmb_FundType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frm_SIE.frx":E96A
         Left            =   120
         List            =   "frm_SIE.frx":E977
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   720
         Width           =   3420
...
Report9 = "SIE"
With frm
'.query = "EXEC [fmis].[dbo].[MPproc_New_RPT_Financials] @from ='" & DTPicker2.Value & "',@to='" & DTPicker1.Value & "',@Accountcode ='',@Fundtype ='" & cmb_FundType.Text & "',@reports = 'SIE'"
.query = "EXECUTE [fmis].[dbo].[MPproc_new_RPT_Financials] @from ='" & DTPicker2.Value & "',@to='" & DTPicker1.Value & "',@Accountcode ='',@Fundcode ='" & cmb_fundtype.ItemData(cmb_fundtype.ListIndex) & "',@reports = 'SIE'"
.accnt = "EXECUTE [fmis].[dbo].[MPproc_new_RPT_Financials] @from ='" & DTPicker2.Value & "',@to='" & DTPicker1.Value & "',@Accountcode ='',@Fundcode ='" & cmb_fundtype.ItemData(cmb_fundtype.ListIndex) & "',@reports = 'SIE_SUB'"
