...
Begin VB.Form frmCreditNoticeEntry 
   Caption         =   "Credit Notice Entry"
   ClientHeight    =   9210
   ClientLeft      =   2295
   ClientTop       =   1185
   ClientWidth     =   14925
   Icon            =   "frmCreditNoticeEntry.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   9210
   ScaleWidth      =   14925
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCreditNoticeEntry.frx":0E42
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCreditNoticeEntry.frx":1EC4
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCreditNoticeEntry.frx":3FFE
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCreditNoticeEntry.frx":5280
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCreditNoticeEntry.frx":810A
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmCreditNoticeEntry"
...
'    If MsgBox("Are You Sure do Want to Delete?", vbYesNo, "System Message") = vbYes Then
'    opndbaseFMIS.Execute "Update tblAMIS_CreditNotice set actioncode = 3 where cnno = '" & Cmb_CnNo.Text & "' and actioncode = 1 "
'    MsgBox "Successfully DELETED", vbInformation, "System Message"
'    Clear
'    Call LoadSavedReport
'    End If
'Else
'MsgBox "No record To Delete", vbInformation, "System Message"
'End If
'End Sub
'
...
'Dim x As Integer
'If MsgBox("Are you Sure do you want to save the Credit Notice in a Voucher?", vbInformation, "System Message") = vbNo Then
'Exit Sub
'End If
'    If Trim(Cmb_CnNo.Text) = "" Then
'    MsgBox "Please fill the Credit Notice No. to proceed..", vbInformation, "System Message"
'    Cmb_CnNo.SetFocus
'    Exit Sub
'    End If
'    If ListView2.ListItems.Count <> 0 Then
'        If cmd_Save.Caption = "&Save" Then
'            If Format(Cmb_CnNo.Text, "0000-00-000") = Cmb_CnNo.Text Then
'                For x = 1 To ListView2.ListItems.Count
'                    opndbaseFMIS.Execute "Insert into tblAMIS_CreditNotice ([Dvno],[Cnno],[Cndate],[ReceivedDate],[Amount],[Userid],[DatetimeEntered],[Actioncode]) " & _
'                                        " Values ('" & ListView2.ListItems(x).ListSubItems(5).Text & "','" & Cmb_CnNo.Text & "','" & DTPCNdate.Value & "','" & DTPRdate.Value & "','" & CCur(ListView2.ListItems(x).ListSubItems(4).Text) & "', '" & Trim(ActiveUserID) & "','" & Now & "',1)"
'                Next x
'            MsgBox "Successfully Save", vbInformation, "System Message"
'            Call LoadSavedReport
'            Clear
'            Else
'            MsgBox "Invalid Format CNNo", vbInformation, "System Message"
'            End If
'        Else
'            opndbaseFMIS.Execute "Update tblAMIS_CreditNotice set actioncode = 2 where cnno = '" & List2.Text & "' and actioncode = 1"
'                For x = 1 To ListView2.ListItems.Count
'                    opndbaseFMIS.Execute "Insert into tblAMIS_CreditNotice ([Dvno],[Cnno],[Cndate],[ReceivedDate],[Amount],[Userid],[DatetimeEntered],[Actioncode]) " & _
'                                        " Values ('" & ListView2.ListItems(x).ListSubItems(5).Text & "','" & Cmb_CnNo.Text & "','" & DTPCNdate.Value & "','" & DTPRdate.Value & "','" & CCur(ListView2.ListItems(x).ListSubItems(4).Text) & "', '" & Trim(ActiveUserID) & "','" & Now & "',1)"
'                Next x
'            MsgBox "Data Successfully Update", vbInformation, "System Message"
'            Call LoadSavedReport
'            Clear
'            cmd_Save.Caption = "&Save"
'        End If
'    Else
'    MsgBox "Check your Entry", vbInformation, "System Message"
'    End If
'End Sub
...
'
'
'sql = " SELECT b.cnno FROM tblAMIS_IncomingDVTrns as a inner join tblAMIS_CreditNotice as b on a.dvno = b.dvno WHERE  b.cnno like '" & txtSearch.Text & "%' AND a.ACTIONCODE = 1 AND b.ACTIONCODE = 1 AND B.ALREADYSAVED2JEV = 0 group by b.cnno order by b.cnno "
'
...
'Dim x
'
'sql = "SELECT * FROM tblAMIS_IncomingDVTrns  WHERE DVNO = '" & DVNo & "' and ACTIONCODE = 1 and Paout = 1 "
'
''Debug.Print sql
'
'opnvoucher.Open sql, opndbaseFMIS, adOpenStatic, adLockOptimistic
'
'If opnvoucher.RecordCount <> 0 Then
'    If Trim(opnvoucher.Fields!obrno) = "NA-21" Or Trim(opnvoucher.Fields!obrno) = "NA-17" Then
...
'            End If
'    Else
'    MsgBox "Dvno Number is not a Liquidition,Cannot Process the Transaction", vbCritical, "System Message"
'    End If
'Else
...
'If KeyAscii = 13 Then
'Call LoadBackBreakdown(txt_RecordID.Text)
'End If
'End Sub
'
