...
Begin VB.Form frmCashConsolidated 
   ...
   End
End
Attribute VB_Name = "frmCashConsolidated"
...
Dim rec As New ADODB.Recordset
 ...
 rs6.Open (query), opndbaseFMIS, adOpenStatic, adLockReadOnly
...
Else
    ...
    Unload Me
End If
 Call StopAvi(frmcashdisbursement_Option.Animation1)
rs6.Close
Set rs6 = Nothing
Exit Sub
err:
