...
Dim strStream As ADODB.Stream
   ...
   cn.Execute "Delete FROM [fmis].[dbo].[tblAMIS_SystemUpdate] where ISID = " & exeID & ""
    ...
    With rs
        .ActiveConnection = cn
        .Source = "Select * FROM [fmis].[dbo].[tblAMIS_SystemUpdate] where ISID = " & exeID & ""
...
Dim strSQL As String
    ...
    cn.ConnectionString = strConnString
    cn.Open
    strSQL = "Select * FROM [fmis].[dbo].[tblAMIS_SystemUpdate] where ISID = " & exeID & ""
